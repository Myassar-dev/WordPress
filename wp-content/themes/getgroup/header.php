...
<head>
	...
	<title>GET Group Holdings | Identity Management and Smart Solutions</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link rel="icon" href="<?php bloginfo('template_directory') ?>/images/logo.png" type="image/gif" sizes="16x16">
...
<div class="site-mobile-menu site-navbar-target">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo m-0 p-0"><a href="/getgroup" class="mb-0">GET Group.</a></h1>
          </div>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(<?= get_field('header-background')['url'] ?>);" data-aos="fade" id="home-section">


      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6 mt-lg-5 text-center">
            <h1><?=  get_field('header-text') ?> </h1>
            <p class="mb-5 site-blocks-cover-p "> <?=  get_field('header-details')?> </p>

          </div>
        </div>
      </div>

      <a href="#about-section" class="smoothscroll arrow-down"><span class="icon-arrow_downward"></span></a>
    </div>
